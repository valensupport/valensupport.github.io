...
All of the URL's referenced in this document can take the optional parameter of solutionVersion. If you are testing a future dated Release, it is a best practive to authenticate with a test user so any scores created are not considered produciton scores.
